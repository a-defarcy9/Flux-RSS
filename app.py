...
def home():
    """Route vers la page d'accueil et le formulaire d'inscription"""
...
@login_required
def flux():
    """Route vers les flux, on récupére les flux de l'utilisateur connecté"""
...
@login_required
def newflux():
    """Route vers le formulaire d'ajout de flux"""
    form = FluxForm()
    if form.validate_on_submit():
        flux = Flux(
            link=form.link.data,
